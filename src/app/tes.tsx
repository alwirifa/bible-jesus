...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="snap-center h-screen w-full relative overflow-hidden text-black">
          <video
      ...
      <div className="fixed bottom-1/2 top-1/2 left-0">
        ...
        <div className="fixed left-4 top-1/2 transform -translate-y-1/2 flex flex-col space-y-4">
          ...
          <button
            ...
            onClick={() => scrollToSection(banner2Ref)}
          >
            <div
              className={`bg-white h-2 w-2 rounded-full  ${
                activeSection === "1"  ? "bg-white" : "bg-transparent"
              }`}
            ></div>
          </button>
          <button
          ...
          <div className="fixed bottom-1/2 top-1/2 left-0"></div>
        </div>
      </div>
    </div>
  );
